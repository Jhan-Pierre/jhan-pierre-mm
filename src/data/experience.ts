...
export const experiences: Experience[] = [
  {
    ...
    skills: ["SQL Server", "C#", ".NET Framework", "Metodología Scrum", "GitHub"],
    achievements: [
  ...
  {
    id: 2,
    title: "Full Stack Developer - Proyecto",
    company: "CORPORACIÓN SANTO DOMINGO DE CAPILLAS S.A.C.",
    ...
    skills: ["Java", "Spring Boot", "Spring Security", "JWT", "SQL Server", "Mockito", "GitHub", "Metodología Scrum"],
    achievements: [
